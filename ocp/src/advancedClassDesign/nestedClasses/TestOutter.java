...
public class TestOutter {
    ...
    public static void main(String... args) {
        ...
        //Public access tests
        assert          new Outter().new PublicMemberInner().privateMI                  == null;              //private no-args constructor
        assert          new Outter().new PublicMemberInner().publicMI                   == null;              //private no-args constructor
        assert          new Outter().new PublicMemberInner("").privateMI                  == null;
        assert          new Outter().new PublicMemberInner("").publicMI                   == null;
